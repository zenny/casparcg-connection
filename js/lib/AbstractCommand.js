...
(function (Command) {
    ...
    var AbstractCommand = (function () {
        ...
        AbstractCommand.prototype.validateParams = function () {
            ...
            for (var _b = 0, validParams_1 = validParams; _b < validParams_1.length; _b++) {
                var param = validParams_1[_b];
                var payload = { key: "", value: null };
         ...
         *
         */
        AbstractCommand.prototype.validateChannel = function (override) {
            var result;
         ...
         *
         */
        AbstractCommand.prototype.validateLayer = function (override) {
            var result;
    ...
    var AbstractOrChannelOrLayerCommand = (function (_super) {
         ...
         *
         */
        function AbstractOrChannelOrLayerCommand(params) {
    ...
    var AbstractChannelCommand = (function (_super) {
         ...
         *
         */
        function AbstractChannelCommand(params) {
            _super.call(this, params);
            var channel = this.validateChannel();
            if (channel) {
                this._channel = channel;
    ...
    var AbstractLayerCommand = (function (_super) {
         ...
         *
         */
        function AbstractLayerCommand(params) {
            _super.call(this, params);
            var channel = this.validateChannel();
            var layer = this.validateLayer();
            if (channel && layer) {
    ...
    var AbstractChannelOrLayerCommand = (function (_super) {
         ...
         *
         */
        function AbstractChannelOrLayerCommand(params) {
            _super.call(this, params);
            var channel = this.validateChannel();
            var layer = this.validateLayer();
            if (channel) {
    ...
    var AbstractLayerWithFallbackCommand = (function (_super) {
         ...
         *
         */
        function AbstractLayerWithFallbackCommand(params) {
            _super.call(this, params);
            var channel = this.validateChannel();
    ...
    var AbstractLayerWithCgFallbackCommand = (function (_super) {
         ...
         *
         */
        function AbstractLayerWithCgFallbackCommand(params) {
            _super.call(this, params);
            var channel = this.validateChannel();
...
//# sourceMappingURL=../maps/lib/AbstractCommand.js.map
