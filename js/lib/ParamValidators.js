...
(function (Validation) {
    ...
    var AbstractValidator = (function () {
         ...
         *
         */
        AbstractValidator.prototype.resolve = function (value, key) {
            return false;
        };
    ...
    var StringValidator = (function (_super) {
         ...
         *
         */
        StringValidator.prototype.resolve = function (data, key) {
            var textstring;
    ...
    var ClipNameValidator = (function (_super) {
         ...
         *
         */
        ClipNameValidator.prototype.resolve = function (data, key) {
            var clipName;
    ...
    var EnumValidator = (function (_super) {
         ...
         *
         */
        EnumValidator.prototype.resolve = function (data, key) {
    ...
    var KeywordValidator = (function (_super) {
         ...
         *
         */
        KeywordValidator.prototype.resolve = function (data, key) {
            ...
            if (data instanceof Array) {
                var arrayCast = [].concat(data);
                if (!this._caseSensitive) {
                    arrayCast = arrayCast.map(function (value) { return String(value).toLowerCase(); });
                }
                ...
                if (!this._caseSensitive) {
                    for (var key_1 in objectCast) {
                        objectCast[key_1] = String(objectCast[key_1]).toLowerCase();
                    }
                }
    ...
    var FrameValidator = (function (_super) {
         ...
         *
         */
        FrameValidator.prototype.resolve = function (data, key) {
            if (data instanceof Array) {
                var arrayCast = [].concat(data);
                var index = void 0;
                arrayCast = arrayCast.map(function (element) { return String(element).toLowerCase(); });
    ...
    var PositiveNumberValidatorBetween = (function (_super) {
         ...
         *
         */
        PositiveNumberValidatorBetween.prototype.resolve = function (data, key) {
            if (typeof data === "number") {
    ...
    var PositiveNumberRoundValidatorBetween = (function (_super) {
         ...
         *
         */
        PositiveNumberRoundValidatorBetween.prototype.resolve = function (data, key) {
            var result = _super.prototype.resolve.call(this, data, key);
            if (result) {
    ...
    var NumberValidatorBetween = (function (_super) {
         ...
         *
         */
        NumberValidatorBetween.prototype.resolve = function (data, key) {
            if (typeof data === "number") {
                var numberCast = Math.max(Math.min(data, this._max), this._min);
                return numberCast;
            }
...
//# sourceMappingURL=../maps/lib/ParamValidators.js.map
