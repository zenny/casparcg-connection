...
(function (Protocol) {
    ...
    var AbstractProtocolLogic = (function () {
         ...
         *
         */
        AbstractProtocolLogic.prototype.resolve = function (protocol) {
            return null;
        };
    ...
    var Depends = (function (_super) {
        ...
        Depends.prototype.ifNot = function () {
            var _this = this;
            var fields = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                fields[_i - 0] = arguments[_i];
...
//# sourceMappingURL=../maps/lib/ProtocolLogic.js.map
